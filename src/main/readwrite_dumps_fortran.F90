...
!
 ...
 do ipass=1,2
    do k=1,ndatatypes
       ...
       if (eos_is_non_ideal(ieos) .and. .not.store_dust_temperature .or. icooling > 0 .or. ieos==25 .or. ieos==8) then
       ...
       if ((eos_outputs_gasP(ieos) .or. eos_is_non_ideal(ieos) .or. ieos==25 .or. ieos==8) .and. k==i_real) then
