...
!   setdisc_carter, setflyby, sethierarchical, spherical, timestep, units,
!   vectorutils
!
 ...
 use set_disc_carter,          only:scaled_sigma,get_disc_mass,maxbins
...
subroutine setup_discs(id,fileprefix,hfact,gamma,npart,polyk,&
 ...
 use set_disc_carter,   only:set_disc
 integer,           intent(in)    :: id
 character(len=20), intent(in)    :: fileprefix
 real,              intent(out)   :: hfact
